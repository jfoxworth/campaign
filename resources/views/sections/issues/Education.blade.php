...
<div class="container clearfix">
    ...
    <div class="heading-block center nobottomborder">
        <h2>Education</h2>
        <span>A New Direction for Education</span>
    </div>
    ...
    <p>While the intent may have been noble, No Child Left Behind and the Obama administrations follow up - Winning the Future - are failures and should be repealed.</p>
    ...
    <div class="fancy-title nobottommargin">
        <h3>End Federal Loan Guarantees</h3>
    </div>
