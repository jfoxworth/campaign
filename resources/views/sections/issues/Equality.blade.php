<div class="heading-block center nobottomborder">
    <h2>Equality for the US and its people</h2>
    <span>A discussion on equality in the US and the equality of the US as a nation.</span>
</div>
...
<div class="container clearfix">
    <div class="col_full">
	    ...
	    <p>The right of a nation and a people to control who enters their lands is the most basic aspect of a nation. The assertion that some countries can limit immigration and retain their culture while others must accept all who enter and change from a single culture to a "multi-cultural" nation is the most fundamentally unequal statement a person can make. The US and its people are the equal of all other nations and peoples and it is time to assert our rights to retain our lands and our culture. (<a href="/Issues/USEquality">more</a>)</p>
    	...
    	<div class="alignright">
    		<a href="#"><img src="/images/issues/equality2.jpg"></a>
    	</div>
		...
		<div class="fancy-title nobottommargin">
			<h3>Congressional Equality - an end to separate systems</h3>
		</div>
	    ...
	    <p>An aggressive reform to congressional income reporting is needed as well with equally aggressive investigations into how each representative accrued their wealth to determine if any representative has sold their influence. (<a href="/Issues/CongressEquality">more</a>)</p>
